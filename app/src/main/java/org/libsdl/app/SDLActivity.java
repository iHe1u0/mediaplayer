 ...
 * SDL Activity
 */
public class SDLActivity extends BaseActivity implements View.OnSystemUiVisibilityChangeListener {
...
*/
    ...
    protected String getMainSharedObject() {
        ...
        Log.d(TAG, "getMainSharedObject: " + Arrays.toString(libraries));
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        try {
            ...
            Log.e(TAG, "surfaceChanged: " + e.getLocalizedMessage(), e.fillInStackTrace());
        }
        ...
        Log.v(TAG, "Device size: " + nDeviceWidth + "x" + nDeviceHeight);
        ...
        if (skip) {
            if (Build.VERSION.SDK_INT >= 24) {
                if (SDLActivity.mSingleton.isInMultiWindowMode()) {
                    Log.v(TAG, "Don't skip in Multi-Window");
                    skip = false;
                }
            }
        }
