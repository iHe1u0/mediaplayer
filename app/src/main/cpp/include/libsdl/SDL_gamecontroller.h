 ...
 */
extern DECLSPEC SDL_Joystick *
SDLCALL SDL_GameControllerGetJoystick(SDL_GameController *gamecontroller);
...
SDLCALL SDL_GameControllerGetStringForButton(SDL_GameControllerButton button);
 ...
 */
extern DECLSPEC int SDLCALL
SDL_GameControllerGetTouchpadFinger(SDL_GameController *gamecontroller, int touchpad, int finger,
 ...
 */
extern DECLSPEC int SDLCALL
SDL_GameControllerSetSensorEnabled(SDL_GameController *gamecontroller, SDL_SensorType type,
                                   SDL_bool enabled);
 ...
 */
extern DECLSPEC int SDLCALL
SDL_GameControllerGetSensorData(SDL_GameController *gamecontroller, SDL_SensorType type,
